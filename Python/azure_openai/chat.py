# semantic_kernel_env is the name of the virtual environment
from dotenv import load_dotenv
import os
import semantic_kernel as sk
from semantic_kernel.connectors.ai.open_ai import AzureChatCompletion
from semantic_kernel.functions import sk_function, sk_function_context_parameter
...
async def main():
    ...
    AZURE_OPEN_AI__CHAT_COMPLETION_DEPLOYMENT_NAME = os.environ["AZURE_DEPLOYMENT_NAME"]
    AZURE_OPEN_AI__ENDPOINT = os.environ["AZURE_ENDPOINT"]
    AZURE_OPEN_AI__API_KEY = os.environ["AZURE_API_KEY"]
